<template>
  <div class="mb-1 flex">
    ...
    >
      ...
      <div
        v-if="summoner"
        class="py-0.2 absolute right-0 bottom-0 translate-x-[30%] rounded-full border border-purple-400/30 bg-neutral-950/85 px-1.5 font-mono text-[9px] font-bold text-purple-200 shadow-[0_0_6px_rgba(139,74,255,0.35)] backdrop-blur-xs"
      >
